...
#No response
	...
	async def tutorial(self, ctx):
		...
		em = discord.Embed(title="Let's get started!", description="You can find the online tutorial [Here](https://solyxbot.webflow.io/tutorial)!\n\n<:Solyx:560809141766193152> **Hello there and welcome to the tutorial!** <:Solyx:560809141766193152> \nHere I will explain a few basic steps to get your adventure started.\n-----------------------------------------------------------------------------------------------\n<:Common:573784881012932618> **To start** <:Common:573784881012932618>\nIf you haven’t done so yet please begin by doing {}start, and then select a race and class. The bot will show you a list of possibilities and you can answer without using the ‘’{}’’.\n\nExample of your input: {}start, human, thief.\n\n-----------------------------------------------------------------------------------------------\n\n<:Sword:573576884688781345> **Quests** <:Sword:573576884688781345> \nNow your adventure begins, to help you walk through the world of Solyx we have designed a series of quests to guide you through the possibilities, do {}quest to get started! it will show you how to Fight, Loot, Gather, Reforge and much more!\n\n-----------------------------------------------------------------------------------------------\n\n<:Magic:560844225839890459> **List of convenient commands** <:Magic:560844225839890459>\n{}vote (gives rewards)\n{}daily (also free rewards)\n{}crate/-lb/-open (consumes 1 crate and 1 key)\n{}hp buy (amount of potions you wish to buy)/{}heal (consumes a potion)\n{}fight\n{}chop\n{}mine\n{}shop armor/shop weapons (NPC standard item shop)\n{}shop sell (inventory number of item you wish to sell)\n{}market (player online market)\n{}wiki (2,3,4 to scroll pages add a number) for any information on items,locations, monsters etc.\n\n:question: For any further questions don't be afraid to contact us or visit us in Solyx Support! A full list of commands is also available on the website.".format(ctx.prefix, ctx.prefix, ctx.prefix, ctx.prefix, ctx.prefix, ctx.prefix, ctx.prefix, ctx.prefix, ctx.prefix, ctx.prefix, ctx.prefix, ctx.prefix, ctx.prefix, ctx.prefix, ctx.prefix, ctx.prefix), color=discord.Colour(0xffffff))
