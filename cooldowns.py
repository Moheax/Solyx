    ...
    async def cooldowns(self, ctx):
        ...
        try:
            ...
            if staytime >= echo > 0:
                ...
                m, s = divmod(seconds, 60)
                embed.add_field(name="Trader", value="<:Gold:639484869809930251> Trader will stay for another " + str(
                    round(m)) + " Minutes and " + str(round(s)) + " Seconds\n\n_ _", inline=False)
                ...
                if delta >= cooldowntime and delta > 0:
                    ...
                    m, s = divmod(seconds, 60)
                    h, m = divmod(m, 60)
                    embed.add_field(name="Trader",
                                    value=":hourglass: Trader is away for another " + str(round(h)) + " Hours, " + str(
                                        round(m)) + " Minutes and " + str(round(s)) + " Seconds\n\n_ _", inline=False)
        except:
            pass
        try:
