...
#           <:ShieldCross:560804112548233217> = Hasnt been made yet.
			...
			embed.add_field(name="**Special**", value="5 - 10 Reduced enemy dmg.", inline=False)
			embed.add_field(name="**Specialization**", value="None yet!", inline=False)
			embed.add_field(name="Back Story", value="None!", inline=False)
			embed.set_footer(text="Submitted by ...\nSubmit your wiki article by sending a dm/message to @TheMaksoo#1212.")
			await ctx.send(embed=embed)
			...
			embed.add_field(name="<:ShieldCross:560804112548233217>**Special**", value="Chance to stun a enemy with an element!", inline=False)
			embed.add_field(name="**Specialization**", value="None yet!", inline=False)
			embed.add_field(name="Back Story", value="None!", inline=False)
			embed.set_footer(text="Submitted by ...\nSubmit your wiki article by sending a dm/message to @TheMaksoo#1212.")
			await ctx.send(embed=embed)
			...
			embed.add_field(name="<:ShieldCross:560804112548233217>**Special**", value="Small chance for the enemy to inflict self dmg.", inline=False)
			embed.add_field(name="**Specialization**", value="None yet!", inline=False)
			embed.add_field(name="Back Story", value="None!", inline=False)
			embed.set_footer(text="Submitted by ...\nSubmit your wiki article by sending a dm/message to @TheMaksoo#1212.")
			await ctx.send(embed=embed)
