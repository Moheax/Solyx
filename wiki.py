...
#			<:Metal:573574661108006915> = metal
			...
			embed.add_field(name="<:ShieldCheck:560804135545602078>Monsters", value="Rachi, Debin, Oofer, Wyvern, Wolf, Goblin, Zombie, Draugr, Stalker, Souleater, Elder Dragon, Hades, Ebony Guardian, Harpy, Dormammu, Ettin, Largos, Deathclaw, Saurian, Skeleton, Lizardmen, Giant, Death Knight", inline=False)
			...
			embed.add_field(name="**Damage**", value="25Dmg - 50Dmg", inline=False)
			embed.add_field(name="**Gold**", value="30G  - 33G", inline=False)
			embed.add_field(name="**Experience**", value="25Exp - 45Exp", inline=False)
			embed.add_field(name="Back Story", value="Write and submit your own backstory! The best will be featured!", inline=False)
			embed.set_footer(text="Submitted by ...\nSubmit your wiki article by sending a dm/message to @TheMaksoo#1212.")
			await ctx.send(embed=embed)
			...
			embed.add_field(name="**Experience**", value="30Exp - 45Exp", inline=False)
			embed.add_field(name="Back Story", value="Write and submit your own backstory! The best will be featured!", inline=False)
			embed.set_footer(text="Submitted by ...\nSubmit your wiki article by sending a dm/message to @TheMaksoo#1212.")
			await ctx.send(embed=embed)
